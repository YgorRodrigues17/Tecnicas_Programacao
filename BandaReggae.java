...
public class BandaReggae extends Banda {
	private String subGenero;
	private int anosAtividade;
	
	public BandaReggae(String nome, String genero, int numIntegrantes, String subGenero) {
		super(nome, genero, numIntegrantes);
		this.subGenero = subGenero;
	}
	public BandaReggae(String nome, String genero, int numIntegrantes, String subGenero, int anosAtividade) {
		super(nome, genero, numIntegrantes);
